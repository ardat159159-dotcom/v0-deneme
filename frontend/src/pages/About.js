    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-blue-50">
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        <div className="bg-white rounded-3xl shadow-xl p-8 md:p-12">
          ...
          <div className="space-y-6 text-gray-700 leading-relaxed">
            <p className="text-lg">
              <strong>lupintr</strong>, içerik üreticilerinin çabalarının karşılığını aldığı yeni nesil sosyal medya platformudur.
            </p>
            ...
            <h2 className="text-2xl font-bold mt-8 mb-4">Neden lupintr?</h2>
            ...
            <div className="mt-12 p-6 bg-gradient-to-r from-purple-100 to-pink-100 rounded-2xl">
              ...
              <p className="mb-4">
                lupintr ailesinin bir parçası olun ve içeriklerinizden para kazanmaya başlayın.
              </p>
              <Link
                to="/register"
      ...
      <footer className="mt-12 py-10 border-t border-gray-200">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-600">© 2025 lupintr. Tüm hakları saklıdır.</p>
